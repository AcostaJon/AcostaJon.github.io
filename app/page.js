    ...
    [
      {
        key: `a${aKeyValue++}`,
        id: `reelBuzzProject`,
        title: "ReelBuzz | Media Streaming App",
        description: "'A web application that keeps users informed and up-to-date with the latest trailers for movies and tv shows",
        languages: ["Reactjs", "Nextjs", "Javascript", "Css","ReactPlayer", "MongoDB"],
      ...
      },
      {
        ...
        title: "2much2say | Podcast Web App",
        description: "'A Podcast for all, You listen we talk!',  is there motto. Check out this podcast",
        languages: ["Reactjs", "Nextjs", "Bootstrap"],
        githubLink: "https://github.com/AcostaJon/2much2say",
        projectLink: "/2much2say",
      ...
      },
      {
        ...
        title: "Wind Breaker | Weather App",
        description: "Here's an easy to use weather app that delivers the latest forecast",
      ...
      },
      {
        ...
        description: "a simple application to search through both a company's current and former employees using search options",
